...
async fn test_dtako_upload_zip() {
    ...
    test_case!("正常なZIPをアップロードして成功する", {
        ...
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoZip").await;
...
async fn test_dtako_upload_invalid_zip() {
    ...
    test_case!("不正なZIPで400エラーを返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoBadZip").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_upload_no_file_field() {
    ...
    test_case!("fileフィールドなしで400を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoNoFile").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
...
async fn test_dtako_internal_download_after_upload() {
    ...
    test_case!("アップロード後にダウンロードする", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoDown").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
...
async fn test_dtako_internal_rerun() {
    ...
    test_case!("アップロード後にrerunで再処理する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRerun").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_dtako_internal_rerun_not_found() {
    ...
    test_case!("存在しないIDでrerunが404を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRerunNF").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
...
async fn test_dtako_split_csv_handler() {
    ...
    test_case!("アップロード後にsplit-csvを実行する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoSplit").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
        ...
        state
            ...
            .upload(
                &r2_key,
                &crate::common::create_test_dtako_zip(),
                "application/zip",
            )
            .await
            .unwrap();
...
async fn test_dtako_split_csv_all_handler() {
    ...
    test_case!("split-csv-allでSSEストリームを消費する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoSplitAll").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_dtako_list_pending_with_data() {
    ...
    test_case!("pending一覧にデータが表示される", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoPending").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_dtako_recalculate_all_with_data() {
    ...
    test_case!("実データありで全ドライバー再計算する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRecalcAll").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
        ...
        // employee + driver_cd
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "RecalcAllDrv", "RA01")
                .await;
...
async fn test_dtako_recalculate_drivers_batch_with_data() {
    ...
    test_case!("実データありでバッチ再計算する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoBatchData").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
        ...
        // employee
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "BatchDrv", "BD01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
        {
            let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_dtako_recalculate_driver() {
    ...
    test_case!("ドライバー再計算SSEが200を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRecalc").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_drivers_list() {
    ...
    test_case!("ドライバー一覧が200を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoDrivers").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_vehicles_list() {
    ...
    test_case!("車両一覧が200を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoVehicles").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_operations_list() {
    ...
    test_case!("運行一覧が200を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoOps").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_operations_calendar() {
    ...
    test_case!("運行カレンダーが200を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoCal").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_daily_hours_list() {
    ...
    test_case!("日別時間一覧が200を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoDH").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_work_times_list() {
    ...
    test_case!("作業時間一覧が200を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoWT").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_event_classifications_list() {
    ...
    test_case!("イベント分類一覧が200を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoEC").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_restraint_report_list() {
    ...
    test_case!("拘束時間レポート一覧を取得する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoReport").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_list_uploads() {
    ...
    test_case!("アップロード一覧が200を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoUploads").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_restraint_report_for_driver() {
    ...
    test_case!(
        "存在しないドライバーでレポートを取得する",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRR").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let client = reqwest::Client::new();
...
async fn test_dtako_restraint_report_json() {
    ...
    test_case!("JSONレポートを取得する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRRJson").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_dtako_restraint_report_json_with_data() {
    ...
    test_case!("実データありでJSONレポートを取得する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRRData").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_dtako_compare_csv_empty() {
    ...
    test_case!("空のCSV比較で400エラーを返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoCmpCSV").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_recalculate_drivers_batch() {
    ...
    test_case!("空バッチ再計算が200を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRecalcBatch").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_restraint_report_full_month() {
    ...
    test_case!("1ヶ月分のレポートを生成する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRRFull").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
        ...
        // employee 作成
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "拘束運転者", "RR01")
                .await;
        let emp_id = emp["id"].as_str().unwrap();
...
async fn test_dtako_daily_hours_with_driver_filter() {
    ...
    test_case!(
        "ドライバーフィルタで日別時間を取得する",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoDHF").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let client = reqwest::Client::new();
...
async fn test_dtako_get_operation_by_unko_no() {
    ...
    test_case!("unko_noで運行を取得する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoGetOp").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();

        let unko_no = 7001;
        // Upload ZIP first
        let zip_bytes = crate::common::create_test_dtako_zip_with_unko_no(unko_no);
        let file_part = reqwest::multipart::Part::bytes(zip_bytes)
            .file_name("test.zip")
            .mime_str("application/zip")
            .unwrap();
...
async fn test_dtako_get_operation_not_found() {
    ...
    test_case!("存在しないunko_noで404を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoGetOpNF").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_delete_operation_by_unko_no() {
    ...
    test_case!("unko_noで運行を削除する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoDelOp").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_delete_operation_not_found() {
    ...
    test_case!("存在しないunko_noで削除が404を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoDelNF").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_restraint_report_after_upload() {
    ...
    test_case!("アップロード後にレポートを取得する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRRUp").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_recalculate_all() {
    ...
    test_case!("全ドライバー再計算SSEが200を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRecAll").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_internal_download() {
    ...
    test_case!("アップロード後にダウンロードする", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoDL").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_internal_download_not_found() {
    ...
    test_case!("存在しないIDでダウンロードが404を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoDLNF").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_restraint_report_pdf() {
    ...
    test_case!("PDFレポートを生成する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRRPdf").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_restraint_report_pdf_all_drivers() {
    ...
    test_case!("全ドライバーPDFを生成する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRRPdfAll").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        crate::common::create_test_employee(&client, &base_url, &auth, "全員PDF", "ALL01").await;
...
async fn test_dtako_restraint_report_pdf_stream() {
    ...
    test_case!("PDFストリームが200を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRRStream").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        crate::common::create_test_employee(&client, &base_url, &auth, "ストリームPDF", "STR01")
            .await;
...
async fn test_dtako_restraint_report_pdf_not_found() {
    ...
    test_case!("存在しないドライバーでPDFが404/500を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRRPdfNF").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_restraint_report_pdf_with_data() {
    ...
    test_case!("実データありでPDFを生成する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRRPdfData").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "PDF実データ", "PD01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
...
async fn test_dtako_restraint_report_pdf_stream_with_data() {
    ...
    test_case!("実データありでPDFストリームを生成する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRRStreamData").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_dtako_restraint_report_with_driver_id() {
    ...
    test_case!("ドライバーIDでレポートを取得する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRRDrv").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_recalculate_driver_core_with_data() {
    ...
    test_case!(
        "実データありでrecalculate_driver_coreが成功する",
        {
            ...
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "RecalcCore").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let client = reqwest::Client::new();
...
async fn test_recalculate_driver_core_no_driver() {
    ...
    test_case!("存在しないドライバーでエラーを返す", {
        ...
        let state = crate::common::setup_app_state().await;
        let _base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RecalcNoDriver").await;
...
async fn test_recalculate_driver_core_no_operations() {
    ...
    test_case!("運行なしで0件を返す", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RecalcNoOps").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_dtako_upload_zip_rich() {
    ...
    test_case!(
        "リッチZIPアップロードでDWHとsegmentsが生成される",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoRich").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
            ...
            let emp1 =
                crate::common::create_test_employee(&client, &base_url, &auth, "運転者A", "A01")
                    .await;
            let emp2 =
                crate::common::create_test_employee(&client, &base_url, &auth, "運転者B", "B01")
                    .await;
...
async fn test_dtako_upload_zip_reupload() {
    ...
    test_case!(
        "同じZIP再アップロードでデータが重複しない",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "DtakoReup").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
...
async fn test_recalculate_driver_core_rich_data() {
    ...
    test_case!(
        "リッチデータでrecalculate_driver_coreが成功する",
        {
            ...
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "RecalcRich").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();

            let emp =
                crate::common::create_test_employee(&client, &base_url, &auth, "運転者A", "RA01")
                    .await;
            let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
            {
                let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_recalculate_driver_core_with_ferry() {
    ...
    test_case!("ferryデータありでrecalculateが成功する", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RecalcFerry").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "FerryDriver", "FD01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
        {
            let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_recalculate_driver_core_invalid_month() {
    ...
    test_case!("無効な月でエラーを返す", {
        ...
        let state = crate::common::setup_app_state().await;
        let _base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RecalcBadMonth").await;
...
async fn test_restraint_report_basic_calculation() {
    ...
    test_case!("基本計算(drive/cargo/is_holiday)を検証する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RRBasic").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "BasicDriver", "BD01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
...
async fn test_restraint_report_holiday_handling() {
    ...
    test_case!("休日と連続休日を正しく処理する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RRHoliday").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "HolidayDrv", "HD01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
...
async fn test_restraint_report_weekly_subtotals() {
    ...
    test_case!("週次小計を正しく計算する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RRWeekly").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "WeeklyDrv", "WD01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
...
async fn test_restraint_report_overtime_calculation() {
    ...
    test_case!("時間外・深夜計算を検証する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RROvertime").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "OtDriver", "OT01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
...
async fn test_restraint_report_overlap_fields() {
    ...
    test_case!(
        "overlapフィールドがrestraint_totalに加算される",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "RROverlap").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
            let emp = crate::common::create_test_employee(
...
async fn test_restraint_report_multiple_dwh_same_day() {
    ...
    test_case!("同日の複数DWH行を処理する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RRMultiDWH").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "MultiDWH", "MD01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
...
async fn test_restraint_report_drive_avg_before() {
    ...
    test_case!("前日運転平均を正しく計算する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RRDriveAvg").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "AvgDriver", "AV01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
...
async fn test_restraint_report_fiscal_year_cumulative() {
    ...
    test_case!("年度累計を正しく計算する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RRFiscal").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "FiscalDrv", "FD01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
...
async fn test_restraint_report_with_operations() {
    ...
    test_case!("operationsデータありでレポートを生成する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RROps").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "OpsDriver", "OD01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
...
async fn test_restraint_report_after_rich_upload() {
    ...
    test_case!("リッチZIP後にレポートとPDFを生成する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RRRichUp").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
        ...
        // employee
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "運転者A", "RA01").await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
        {
            let mut conn = state.pool().acquire().await.unwrap();
            sqlx::query("SELECT set_config('app.current_tenant_id', $1, true)")
...
async fn test_dtako_split_csv_not_found() {
    ...
    test_case!("存在しないupload_idで500を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "SplitNF").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
...
async fn test_dtako_internal_download_r2_missing() {
    ...
    test_case!("R2にZIPがない場合に500を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DownR2Miss").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_dtako_internal_rerun_bad_zip() {
    ...
    test_case!("壊れたZIPでrerunが400を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RerunBad").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_dtako_recalculate_driver_error_event() {
    ...
    test_case!(
        "存在しないドライバーでSSEエラーイベントを返す",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "RecalcErr").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
...
async fn test_dtako_recalculate_drivers_batch_invalid_month() {
    ...
    test_case!("無効な月でSSEエラーを返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "BatchInvMonth").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
...
async fn test_dtako_recalculate_drivers_batch_driver_not_found() {
    ...
    test_case!("存在しないドライバーでバッチ完了する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "BatchNoDriver").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
...
async fn test_dtako_internal_rerun_r2_download_fail() {
    ...
    test_case!("R2ダウンロード失敗でrerunが500を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RerunR2Fail").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_dtako_internal_download_unicode_filename() {
    ...
    test_case!("Unicodeファイル名でダウンロードする", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DownUnicode").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_dtako_mark_upload_failed_success() {
    ...
    test_case!("mark_upload_failedが正常に動作する", {
        ...
        let state = crate::common::setup_app_state().await;
        let _base = crate::common::spawn_test_server(state.clone()).await;
        let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_recalculate_all_core_invalid_month() {
    ...
    test_case!("recalculate_all_coreが無効な月でエラーを返す", {
        ...
        let state = crate::common::setup_app_state().await;
        let _base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RecAllInv").await;
...
async fn test_recalculate_all_core_no_kudgivt() {
    ...
    test_case!(
        "recalculate_all_coreがKUDGIVTなしでエラーを返す",
        {
            ...
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "RecAllNoKG").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();

            let emp =
                crate::common::create_test_employee(&client, &base_url, &auth, "NoKGDrv", "NK01")
                    .await;
            let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
            {
                let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_recalculate_all_core_december() {
    ...
    test_case!("recalculate_all_coreが12月で正常動作する", {
        ...
        let state = crate::common::setup_app_state().await;
        let _base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RecAllDec").await;
        // operations なし → 0件で成功
...
async fn test_dtako_internal_download_all_japanese_filename() {
    ...
    test_case!(
        "全日本語ファイル名でdownload.zipにフォールバックする",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "DownJP").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
...
async fn test_dtako_recalculate_all_invalid_month() {
    ...
    test_case!("recalculate-all SSEが無効な月でエラーを返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RecalcAllInv").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
...
async fn test_dtako_recalculate_drivers_batch_december() {
    ...
    test_case!("12月のバッチ再計算が成功する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "BatchDec").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
...
async fn test_recalculate_driver_core_december() {
    ...
    test_case!("12月のrecalculate_driver_coreが成功する", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RecalcDec").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "DecDriver", "DC01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
        {
            let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_dtako_recalculate_driver_sse_done() {
    ...
    test_case!(
        "実データありでSSEのdoneイベントを確認する",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "RecalcSSE").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();

            let emp =
                crate::common::create_test_employee(&client, &base_url, &auth, "SSEDrv", "SD01")
                    .await;
            let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
            {
                let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_dtako_recalculate_all_no_kudgivt() {
    ...
    test_case!(
        "KUDGIVTなしでrecalculate-allのSSEイベントを確認する",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "RecalcNoKGVT").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();

            let emp =
                crate::common::create_test_employee(&client, &base_url, &auth, "NoKGVTDrv", "NK01")
                    .await;
            let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
            {
                let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_dtako_split_csv_all_empty() {
    ...
    test_case!("operationsなしでsplit-csv-allが即done返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "SplitAllEmpty").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
...
async fn test_dtako_upload_empty_kudguri() {
    ...
    test_case!("空KUDGURIで0件を返す", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "EmptyKud").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
...
async fn test_dtako_upload_empty_cd_fields() {
    ...
    test_case!(
        "空CDフィールドでもアップロードが成功する",
        {
            ...
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "EmptyCD").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
...
async fn test_dtako_upload_edge_cases_302_and_ferry_format() {
    ...
    test_case!("302休息とferry代替フォーマットを処理する", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Edge302").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "Edge302Drv", "E302")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
        {
            let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_dtako_internal_rerun_with_r2_key() {
    ...
    test_case!("R2キーありでrerunが成功する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RerunR2").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_recalculate_drivers_batch_core_invalid_month() {
    ...
    test_case!("batch_coreが無効な月でエラーを返す", {
        ...
        let state = crate::common::setup_app_state().await;
        let _base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "BatchCoreInv").await;
...
async fn test_recalculate_drivers_batch_core_driver_error() {
    ...
    test_case!(
        "batch_coreがドライバーエラーをカウントする",
        {
            ...
            let state = crate::common::setup_app_state().await;
            let _base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "BatchCoreErr").await;
...
async fn test_split_csv_all_core_empty() {
    ...
    test_case!("split_csv_all_coreが空で(0,0)を返す", {
        ...
        let state = crate::common::setup_app_state().await;
        let _base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "SplitCoreEmpty").await;
...
async fn test_split_csv_all_core_with_failures() {
    ...
    test_case!("split_csv_all_coreが失敗をカウントする", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "SplitCoreFail").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_recalculate_with_zero_duration_ferry() {
    ...
    test_case!("duration=0のferryデータを処理する", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "ZeroFerry").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "ZFDrv", "ZF01").await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
        {
            let mut conn = state.pool().acquire().await.unwrap();
            sqlx::query("SELECT set_config('app.current_tenant_id', $1, true)")
...
async fn test_dtako_split_csv_all_core_db_error() {
    ...
    test_case!("split_csv_all_coreがDBエラーで(0,0)を返す", {
        ...
        let state = crate::common::setup_app_state().await;
        let _base = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "SplitDBErr").await;
...
async fn test_dtako_upload_split_csv_fails_gracefully() {
    ...
    test_case!("split_csv失敗でもアップロードは成功する", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "SplitFail").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
...
async fn test_recalculate_with_corrupted_zip_in_r2() {
    ...
    test_case!("壊れたZIPのR2でrecalculateが動作する", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "CorruptZip").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "CorruptDrv", "CZ01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
        {
            let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_recalculate_all_core_bad_kudgivt_csv() {
    ...
    test_case!("壊れたKUDGIVT CSVでエラーを返す", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "BadKGVTcsv").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "BadCsvDrv", "BC01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
        {
            let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_recalculate_with_bad_ferry_data() {
    ...
    test_case!("不正なferryデータでも成功する", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "BadFerry").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "BadFerryDrv", "BF01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
        {
            let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_recalculate_with_duplicate_zip_keys() {
    ...
    test_case!("重複ZIPキーでrecalculateが動作する", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DupZip").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "DupZipDrv", "DZ01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
        {
            let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_dtako_split_csv_all_with_bad_zip() {
    ...
    test_case!("壊れたZIPでsplit-csv-allのSSEイベントを返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "SplitBad").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_upload_triggers_split_failure() {
    ...
    test_case!("split失敗でもアップロードは成功する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "SplitFail2").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
...
async fn test_load_kudgivt_error_paths() {
    ...
    test_case!("load_kudgivtの各エラーパスを通る", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "KGVTErr").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "KGVTErrDrv", "KE01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
        {
            let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_split_csv_no_kudgivt_in_zip() {
    ...
    test_case!("KUDGIVT無しZIPでsplit-csvが成功する", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "SplitNoKGVT").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_load_kudgivt_parse_error_in_valid_zip() {
    ...
    test_case!(
        "有効ZIP内の壊れたKUDGIVTパースエラーを処理する",
        {
            ...
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "KGVTParse").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
...
async fn test_classification_insert_db_error() {
    ...
    test_case!(
        "classification INSERT失敗時にログ出力して続行する",
        {
            ...
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "ClsInsErr").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();

            let emp =
                crate::common::create_test_employee(&client, &base_url, &auth, "ClsErrDrv", "CE01")
                    .await;
            let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
            {
                let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_has_kudgivt_update_error() {
    ...
    test_case!("has_kudgivt UPDATE失敗時にログ出力する", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "HasKGVTErr").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_split_csv_all_sse_error_path() {
    ...
    test_case!(
        ...
        {
            let state = crate::common::setup_app_state().await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "SSESplitErr").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let base_url = crate::common::spawn_test_server(state.clone()).await;
...
async fn test_ferry_no_matching_kudgivt_events() {
    ...
    test_case!("ferry_minutesにKUDGIVTが無いunko_noを処理する", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "FerryNoKGVT").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "FerryNoKDrv", "FK01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
        {
            let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_ferry_parse_invalid_datetime() {
    ...
    test_case!("ferryの不正日時パース失敗を処理する", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "FerryBadDT").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "FerryBadDTDrv", "FD01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
        {
            let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_split_csv_with_kudgivt_zip() {
    ...
    test_case!("KUDGIVT入りZIPでsplit-csvが成功する", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "SplitKGVT").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_ferry_short_columns() {
    ...
    test_case!("11列以下のferryデータをスキップする", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "FerryShort").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "FerryShortDrv", "FS01")
                .await;
        let emp_id: Uuid = emp["id"].as_str().unwrap().parse().unwrap();
        {
            let mut conn = state.pool().acquire().await.unwrap();
...
async fn test_split_csv_with_non_csv_file_in_zip() {
    ...
    test_case!("ZIP内の非CSVファイルをスキップする", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "SplitNonCSV").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_upload_split_csv_from_r2_error_via_trigger() {
    ...
    test_case!(
        "トリガーでr2_zipキーを壊してsplit失敗を再現する",
        {
            ...
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "SplitTrig").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
...
async fn test_upload_split_csv_from_r2_error() {
    ...
    test_case!("存在しないR2キーでsplit-csvが500を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "SplitR2Err").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_restraint_report_invalid_year_month() {
    ...
    test_case!("無効な year/month → 400 BAD_REQUEST (L221)", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RRInvMonth").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "無効月運転者", "INV01")
                .await;
        let emp_id = emp["id"].as_str().unwrap();
...
async fn test_restraint_report_december() {
    ...
    test_case!("month=12 → 年越し処理 (L224)", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RRDec").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "12月運転者", "DEC01")
                .await;
        let emp_id = emp["id"].as_str().unwrap();
...
async fn test_restraint_report_db_error_internal_err() {
    ...
    test_case!("DB RENAME → internal_err (L605-611)", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RRDbErr").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_restraint_report_compare_csv_upload() {
    ...
    test_case!("multipart CSV アップロード (L719-731)", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RRCmpCSV").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_restraint_report_compare_csv_with_driver_filter() {
    ...
    test_case!("driver_cd フィルター付き CSV 比較", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "RRCmpFilt").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_restraint_report_last_day_drive_avg_and_weekly_subtotal() {
    ...
    test_case!(
        "最終日 drive_avg_after=0 + final weekly subtotal (L557, L564-570)",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "RRLastDay").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
...
async fn test_restraint_report_empty_dwh_list() {
    ...
    test_case!(
        "dwh_list が空 → vec![None] フォールバック (L431)",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "RRNoDwh").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();

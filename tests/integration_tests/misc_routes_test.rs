...
async fn test_tenko_call_list_numbers() {
    ...
    test_case!("電話番号マスタ一覧を取得できる", {
        ...
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Tenko Call").await;
...
async fn test_tenko_call_list_drivers() {
    ...
    test_case!("登録運転者一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Tenko Drivers").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_tenko_call_register_driver() {
    ...
    test_case!(
        "運転者を電話番号マスタ経由で登録できる",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "Tenko Reg").await;
            let client = reqwest::Client::new();
...
async fn test_timecard_cards_crud() {
    ...
    test_case!("カードのCRUD操作ができる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Timecard").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        ...
        // 従業員作成
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "TimecardEmp", "TC01")
                .await;
...
async fn test_timecard_punch() {
    ...
    test_case!("カードIDで打刻できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Punch").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "PunchEmp", "PU01")
                .await;
        let emp_id = emp["id"].as_str().unwrap();
...
async fn test_timecard_punches_list() {
    ...
    test_case!("打刻一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Punches List").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_tenko_schedules_list() {
    ...
    test_case!("スケジュール一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Tenko Sched").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_tenko_sessions_list() {
    ...
    test_case!("セッション一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Tenko Sess").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_tenko_records_list() {
    ...
    test_case!("点呼記録一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Tenko Rec").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_health_baselines_list() {
    ...
    test_case!("健康基準値一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Health BL").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_equipment_failures_list() {
    ...
    test_case!("機器故障一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Equip Fail").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_tenko_webhooks_list() {
    ...
    test_case!("Webhook一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Webhooks").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_carrying_items_crud() {
    ...
    test_case!("携行品目のCRUD操作ができる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Carry CRUD").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_communication_items_crud() {
    ...
    test_case!("連絡事項のCRUD操作ができる", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Comm CRUD").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_carrying_items_list() {
    ...
    test_case!("携行品目一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Carrying").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_communication_items_list() {
    ...
    test_case!("連絡事項一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Comms").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_guidance_records_crud() {
    ...
    test_case!("指導記録のCRUD操作ができる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Guidance").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
        ...
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "GuidEmp", "GE01").await;
        let emp_id = emp["id"].as_str().unwrap();
...
async fn test_guidance_records_upload_attachment() {
    ...
    test_case!(
        "添付ファイルをアップロードして一覧取得できる",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "GuidAtt").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();

            let emp =
                crate::common::create_test_employee(&client, &base_url, &auth, "AttEmp", "AT01")
                    .await;
            let emp_id = emp["id"].as_str().unwrap();
...
async fn test_guidance_records_list_with_date_filter() {
    ...
    test_case!(
        "日付フィルタ付きで指導記録一覧を取得できる",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "GuidDate").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
...
async fn test_tenant_users_list() {
    ...
    test_case!("テナントユーザー一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "TenantUsers").await;
        let (user_id, _) =
            crate::common::create_test_user_in_db(state.pool(), tenant_id, "tu@test.com", "admin")
                .await;
        let jwt =
            crate::common::create_test_jwt_for_user(user_id, tenant_id, "tu@test.com", "admin");
        let client = reqwest::Client::new();
...
async fn test_tenant_users_invite_and_delete() {
    ...
    test_case!(
        "ユーザー招待・招待一覧・招待削除・ユーザー削除ができる",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "TUInvite").await;
            ...
            // delete user
            // 他のユーザーを作成して削除
            let (other_id, _) = crate::common::create_test_user_in_db(
                state.pool(),
                tenant_id,
                "other-tu@test.com",
                "viewer",
...
async fn test_daily_health_status() {
    ...
    test_case!("日次健康状態を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DailyHealth").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_daily_health_status_with_date() {
    ...
    test_case!("日付指定で日次健康状態を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DailyHealthD").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_driver_info() {
    ...
    test_case!("従業員IDで運転者情報を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "DriverInfo").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "InfoEmp", "DI01").await;
        let emp_id = emp["id"].as_str().unwrap();
...
async fn test_timecard_punches_csv() {
    ...
    test_case!("打刻データをCSVエクスポートできる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "CSV Punch").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "CsvEmp", "CSV1").await;
        let emp_id = emp["id"].as_str().unwrap();
...
async fn test_timecard_punches_with_filter() {
    ...
    test_case!(
        "従業員IDフィルタ付きで打刻一覧を取得できる",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "FilterPunch").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();

            let emp =
                crate::common::create_test_employee(&client, &base_url, &auth, "FiltEmp", "FI01")
                    .await;
            let emp_id = emp["id"].as_str().unwrap();
...
async fn test_carins_files_delete_then_download() {
    ...
    test_case!("ファイル削除後に一覧から除外される", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "CarinsDel").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_timecard_punch_nfc_fallback() {
    ...
    test_case!(
        "カード未登録時にemployees.nfc_idフォールバックで打刻できる",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "NfcPunch").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
            ...
            // 従業員作成
            let emp =
                crate::common::create_test_employee(&client, &base_url, &auth, "NfcEmp", "NF01")
                    .await;
            let emp_id = emp["id"].as_str().unwrap();
...
async fn test_timecard_get_card_by_card_id_not_found() {
    ...
    test_case!("存在しないcard_idで取得すると404を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "CardNotFound").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_timecard_csv_with_employee_filter() {
    ...
    test_case!(
        "従業員IDフィルタ付きでCSVエクスポートできる",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "CsvFilter").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
...
async fn test_communication_items_create_all_fields_and_list_active() {
    ...
    test_case!(
        "全フィールド指定で作成し有効期限内のみactive一覧に表示される",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "CommAll").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
...
async fn test_health_baselines_update_with_put() {
    ...
    test_case!("POST作成後にPUTで部分更新できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "HBUpdate").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "HBEmp", "HB01").await;
        let emp_id = emp["id"].as_str().unwrap();
...
async fn test_health_baselines_upsert_twice_no_duplicate() {
    ...
    test_case!("同一従業員に2回upsertしても重複しない", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "HBUpsert").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "UpsertEmp", "UP01")
                .await;
        let emp_id = emp["id"].as_str().unwrap();
...
async fn test_tenko_call_tenko() {
    ...
    test_case!(
        "登録済み運転者でGPS付き点呼を送信できる",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "TenkoSend").await;
            let client = reqwest::Client::new();
...
async fn test_tenko_call_delete_number() {
    ...
    test_case!("電話番号マスタを削除できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "TenkoDelNum").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_car_inspections_current() {
    ...
    test_case!("有効な車検証一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "CarIns").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_car_inspections_expired() {
    ...
    test_case!("期限切れ車検証一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "CarInsExp").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_car_inspections_renew() {
    ...
    test_case!("更新対象の車検証一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "CarInsRen").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_car_inspections_vehicle_categories() {
    ...
    test_case!("車両カテゴリ一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "VehCat").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_car_inspection_files_current() {
    ...
    test_case!("有効な車検証ファイル一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "CarInsFiles").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_guidance_records_child_record() {
    ...
    test_case!(
        "親子レコードを作成し親削除で子も再帰削除される",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "GuidChild").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();

            let emp =
                crate::common::create_test_employee(&client, &base_url, &auth, "ChildEmp", "CE01")
                    .await;
            let emp_id = emp["id"].as_str().unwrap();
...
async fn test_guidance_records_attachments_empty_after_creation() {
    ...
    test_case!("作成直後の添付ファイル一覧は空である", {
        ...
        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "AttEmp", "AT01").await;
        let emp_id = emp["id"].as_str().unwrap();
...
async fn test_guidance_records_filter_by_guidance_type() {
    ...
    test_case!(
        "guidance_typeでフィルタして指導記録を取得できる",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "GuidType").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();

            let emp =
                crate::common::create_test_employee(&client, &base_url, &auth, "TypeEmp", "TY01")
                    .await;
            let emp_id = emp["id"].as_str().unwrap();
...
async fn test_carrying_items_with_vehicle_conditions() {
    ...
    test_case!(
        "vehicle_conditions付きで携行品目を作成・更新・取得できる",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "CarryVC").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
...
async fn test_car_inspections_get_by_fake_id_returns_404() {
    ...
    test_case!(
        "存在しないIDで車検証を取得すると404を返す",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "CarIns404").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let client = reqwest::Client::new();
...
async fn test_bot_admin_update_config() {
    ...
    test_case!("Bot設定を作成後にupsertで更新できる", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "BotUpd").await;
        let (user_id, _) = crate::common::create_test_user_in_db(
            state.pool(),
            tenant_id,
            "botupd@test.com",
        ...
        .await;
        let jwt =
            crate::common::create_test_jwt_for_user(user_id, tenant_id, "botupd@test.com", "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_nfc_tags_list() {
    ...
    test_case!("NFCタグ一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "NFC Tags").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_timecard_punches_with_date_filter() {
    ...
    test_case!(
        "日付フィルタ付きで打刻一覧を取得できる",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "PunchDateF").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();

            let emp =
                crate::common::create_test_employee(&client, &base_url, &auth, "DateFEmp", "DF01")
                    .await;
            let emp_id = emp["id"].as_str().unwrap();
...
async fn test_timecard_csv_with_date_filter() {
    ...
    test_case!(
        "日付フィルタ付きでCSVエクスポートできる",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "CsvDateF").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();

            let emp =
                crate::common::create_test_employee(&client, &base_url, &auth, "CsvDFEmp", "CD01")
                    .await;
            let emp_id = emp["id"].as_str().unwrap();
...
async fn test_tenko_call_register_invalid_call_number() {
    ...
    test_case!(
        "未登録の電話番号マスタで登録すると400を返す",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let _tenant_id = crate::common::create_test_tenant(state.pool(), "TenkoBadReg").await;
            let client = reqwest::Client::new();
...
async fn test_tenko_call_tenko_unregistered_phone() {
    ...
    test_case!("未登録の電話番号で点呼すると404を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let _tenant_id = crate::common::create_test_tenant(state.pool(), "TenkoNoPhone").await;
        let client = reqwest::Client::new();
...
async fn test_tenko_webhook_deliveries() {
    ...
    test_case!("Webhook作成後にdeliveries一覧を取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "WhDeliv").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_nfc_tags_crud() {
    ...
    test_case!("NFCタグの登録・検索・削除ができる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "NFC CRUD").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_nfc_tags_upsert() {
    ...
    test_case!(
        "同一UUIDで2回登録するとcar_inspection_idが更新される",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "NFC Upsert").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
...
async fn tenko_completed_classifications_after_upload_and_update() {
    ...
    test_case!(
        "アップロード後にイベント分類を取得・更新できる",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "EC Update").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
...
async fn test_dtako_csv_proxy_kudguri() {
    ...
    test_case!("KUDGURI CSVをJSON形式で取得できる", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "CsvProxy").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_dtako_csv_proxy_kudgivt() {
    ...
    test_case!(
        "KUDGIVT (イベント) CSVをJSON形式で取得できる",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "CsvProxyEvt").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
...
async fn test_webhook_deliver_connection_error() {
    ...
    test_case!(
        "接続エラー時にリトライしてdeliveries記録する",
        {
            ...
            let state = crate::common::setup_app_state().await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "WhConnErr").await;
...
async fn test_webhook_fire_event_delivery_error_logged() {
    ...
    test_case!("fire_event でエラー時にログ記録される", {
        let state = crate::common::setup_app_state().await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "WhFireErr").await;
...
async fn test_timecard_create_card_conflict() {
    ...
    test_case!("重複カードIDで409を返す", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "TC Conflict").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "ConflictEmp", "CF01")
                .await;
        let emp_id = emp["id"].as_str().unwrap();
...
async fn test_timecard_list_cards_with_employee_filter() {
    ...
    test_case!("employee_idフィルター付きカード一覧", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "TC Filter").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp1 =
            crate::common::create_test_employee(&client, &base_url, &auth, "FilterEmp1", "FE01")
                .await;
        let emp1_id = emp1["id"].as_str().unwrap();
        let emp2 =
            crate::common::create_test_employee(&client, &base_url, &auth, "FilterEmp2", "FE02")
                .await;
...
async fn test_timecard_delete_card_not_found() {
    ...
    test_case!("存在しないカード削除で404", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "TC DelNF").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_communication_items_get_by_id() {
    ...
    test_case!("IDで連絡事項を取得", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "CommGetId").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_communication_items_get_by_id_not_found() {
    ...
    test_case!("存在しないIDで404", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "CommNF").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_communication_items_update_not_found() {
    ...
    test_case!("存在しないIDをupdateで404", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "CommUpdNF").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_communication_items_delete_not_found() {
    ...
    test_case!("存在しないIDをdeleteで404", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "CommDelNF").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_communication_items_create_db_error() {
    ...
    test_case!("create: trigger → 500", {
        ...
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "CommCreateErr").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

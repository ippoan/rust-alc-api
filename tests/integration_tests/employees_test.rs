...
async fn test_tenant_isolation() {
    ...
    test_case!(
        "テナントAの従業員がテナントBから見えないこと",
        {
            ...
            let tenant_a = crate::common::create_test_tenant(state.pool(), "Tenant A").await;
            let tenant_b = crate::common::create_test_tenant(state.pool(), "Tenant B").await;

            let jwt_a = crate::common::create_test_jwt(tenant_a, "admin");
            let jwt_b = crate::common::create_test_jwt(tenant_b, "admin");
...
async fn test_kiosk_mode_with_tenant_header() {
    ...
    test_case!(
        "X-Tenant-IDヘッダーによるキオスクモード認証",
        {
            ...
            let tenant_id = crate::common::create_test_tenant(state.pool(), "Kiosk Tenant").await;
...
async fn test_create_employee() {
    ...
    test_case!("従業員を作成できること", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Create Emp").await;
...
async fn test_create_employee_with_optional_fields() {
    ...
    test_case!(
        "オプションフィールド付きで従業員を作成できること",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "Opt Fields").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let client = reqwest::Client::new();
...
async fn test_list_employees_empty() {
    ...
    test_case!(
        "従業員がいない場合は空リストを返すこと",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "Empty List").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let client = reqwest::Client::new();
...
async fn test_list_employees_returns_created() {
    ...
    test_case!("作成した従業員が一覧に表示されること", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "List Emp").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        crate::common::create_test_employee(&client, &base_url, &auth, "Alice", "A01").await;
        crate::common::create_test_employee(&client, &base_url, &auth, "Bob", "B01").await;
...
async fn test_get_employee_by_id() {
    ...
    test_case!("IDで従業員を取得できること", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Get Emp").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "Taro", "T01").await;
...
async fn test_get_employee_not_found() {
    ...
    test_case!("存在しない従業員IDで404を返すこと", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Not Found").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_update_employee() {
    ...
    test_case!("従業員情報を更新できること", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Update Emp").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "OldName", "OLD1").await;
        let id = emp["id"].as_str().unwrap();
...
async fn test_delete_employee() {
    ...
    test_case!("従業員を削除できること", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Delete Emp").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "ToDelete", "DEL1")
                .await;
        let id = emp["id"].as_str().unwrap();
...
async fn test_delete_employee_not_found() {
    ...
    test_case!("存在しない従業員の削除で404を返すこと", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Del NF").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let client = reqwest::Client::new();
...
async fn test_get_employee_by_nfc() {
    ...
    test_case!("NFC IDで従業員を取得できること", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "NFC Emp").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();
...
async fn test_get_employee_by_code() {
    ...
    test_case!("コードで従業員を取得できること", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "Code Emp").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        crate::common::create_test_employee(&client, &base_url, &auth, "CodeUser", "MYCODE").await;
...
async fn test_update_nfc_id() {
    ...
    test_case!("NFC IDを更新できること", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "NfcUpdate").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "NfcUpd", "NU01").await;
        let id = emp["id"].as_str().unwrap();
...
async fn test_update_license() {
    ...
    test_case!("免許情報を更新できること", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "LicUpdate").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "LicUpd", "LU01").await;
        let id = emp["id"].as_str().unwrap();
...
async fn test_update_face_invalid_embedding() {
    ...
    test_case!("不正な次元のembeddingで400を返すこと", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "FaceInv").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "FaceInv", "FI01").await;
        let id = emp["id"].as_str().unwrap();
...
async fn test_update_face_and_approve() {
    ...
    test_case!(
        "顔登録して承認するとface-dataに表示されること",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "FaceApprove").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();

            let emp =
                crate::common::create_test_employee(&client, &base_url, &auth, "FaceApp", "FA01")
                    .await;
            let id = emp["id"].as_str().unwrap();
...
async fn test_update_face_and_reject() {
    ...
    test_case!("顔登録して却下できること", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "FaceReject").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "FaceRej", "FR01").await;
        let id = emp["id"].as_str().unwrap();
...
async fn test_list_face_data_empty() {
    ...
    test_case!(
        "顔データがない場合は空リストを返すこと",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "Face Data").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let client = reqwest::Client::new();
...
async fn test_update_face_valid_embedding_pending() {
    ...
    test_case!(
        "有効なembeddingで顔登録するとpendingになること",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "FacePend").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
...
async fn test_face_approve_visible_in_face_data() {
    ...
    test_case!("承認後にface-dataに表示されること", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "FaceVis").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "FaceVisEmp", "FV01")
                .await;
        let id = emp["id"].as_str().unwrap();
...
async fn test_face_reject_not_in_face_data() {
    ...
    test_case!(
        "却下された顔データはface-dataに表示されないこと",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "FaceRejND").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();
...
async fn test_face_approve_non_pending_returns_404() {
    ...
    test_case!("pending以外の従業員の承認で404を返すこと", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "FaceAppNP").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "NoFaceEmp", "NF01")
                .await;
        let id = emp["id"].as_str().unwrap();
...
async fn test_face_reject_non_pending_returns_404() {
    ...
    test_case!("pending以外の従業員の却下で404を返すこと", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "FaceRejNP").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp =
            crate::common::create_test_employee(&client, &base_url, &auth, "NoFaceEmp2", "NF02")
                .await;
        let id = emp["id"].as_str().unwrap();
...
async fn test_face_reregister_resets_to_pending() {
    ...
    test_case!(
        "承認後に再登録するとpendingにリセットされること",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "FaceReReg").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();

            let emp =
                crate::common::create_test_employee(&client, &base_url, &auth, "ReRegEmp", "RR01")
                    .await;
            let id = emp["id"].as_str().unwrap();
...
async fn test_update_face_nonexistent_employee() {
    ...
    test_case!(
        "存在しない従業員の顔更新で404を返すこと",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "FaceNE").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let client = reqwest::Client::new();
...
async fn test_update_face_photo_only_no_status_change() {
    ...
    test_case!(
        "写真URLのみの更新でステータスが変わらないこと",
        {
            let state = crate::common::setup_app_state().await;
            let base_url = crate::common::spawn_test_server(state.clone()).await;
            let tenant_id = crate::common::create_test_tenant(state.pool(), "FacePhoto").await;
            let jwt = crate::common::create_test_jwt(tenant_id, "admin");
            let auth = format!("Bearer {jwt}");
            let client = reqwest::Client::new();

            let emp =
                crate::common::create_test_employee(&client, &base_url, &auth, "PhotoEmp", "PH01")
                    .await;
            let id = emp["id"].as_str().unwrap();
...
async fn test_update_employee_code_conflict() {
    ...
    test_case!("重複コードで更新すると409", {
        let state = crate::common::setup_app_state().await;
        let base_url = crate::common::spawn_test_server(state.clone()).await;
        let tenant_id = crate::common::create_test_tenant(state.pool(), "CodeConflict").await;
        let jwt = crate::common::create_test_jwt(tenant_id, "admin");
        let auth = format!("Bearer {jwt}");
        let client = reqwest::Client::new();

        let emp1 =
            crate::common::create_test_employee(&client, &base_url, &auth, "Emp1", "CODE-A").await;
        let _emp2 =
            crate::common::create_test_employee(&client, &base_url, &auth, "Emp2", "CODE-B").await;

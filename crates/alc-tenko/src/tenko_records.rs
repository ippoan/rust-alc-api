...
async fn export_csv(
    ...
    wtr.write_record([
        ...
        "manager_judgment",
        "manager_judgment_reason",
        "manager_judgment_by_name",
    ...
    for r in &records {
        ...
        wtr.write_record([
            ...
            judgment_status,
            judgment_items,
            r.manager_judgment.clone().unwrap_or_default(),
            r.manager_judgment_reason.clone().unwrap_or_default(),
            r.manager_judgment_by_name.clone().unwrap_or_default(),
            inspection_status,

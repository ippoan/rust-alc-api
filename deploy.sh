...
gcloud run deploy $SERVICE_NAME \
  ...
  --set-env-vars "STORAGE_BACKEND=r2,R2_BUCKET=alc-face-photos,R2_ACCOUNT_ID=24b45709d060d957340180e995f0d373,FCM_PROJECT_ID=alc-fcm,API_ORIGIN=https://alc-api.ippoan.org,CARINS_R2_BUCKET=carins-files,DTAKO_R2_BUCKET=ohishi-dtako,NOTIFY_R2_BUCKET=notify-files,NOTIFY_REDACT_BROADCAST_URL=https://realtime.notify.ippoan.org/broadcast,NOTIFY_REDACT_2STAGE=1,SCRAPER_URL=https://dtako-scraper-566bls5vfq-an.a.run.app" \
  --port 8080 \
  --memory 1Gi \
  --cpu 1 \
  --max-instances 3

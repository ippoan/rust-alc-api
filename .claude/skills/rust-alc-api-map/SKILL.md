...
generated-from: rust-alc-api:4e1e603c8e8038005f12a6b031d768d0440e6f9c
...
| `tests/dtako_operation_changes_test.rs` | 運行の変更記録 (migration 152、Refs ohishi-exp/nuxt-dtako-admin#1133) — 休憩 0→178 の上げ直しで reupload 1 行 / 同じ中身・初回取り込みは 0 行 / 旧 KUDGIVT が取れない回は分数を比べない / 手動削除は crew_role ごとに manual_delete・after=NULL / 2マンは crew_role ごとに対応 / 読み口は別 tenant を返さない |
